...
const handelCategory = async () => {
  ...
  const trimData = data.data.news_category.slice(0, 5);
...
const handleLoadNews = async (categoryId) => {
  ...
  data?.data.forEach((news) => {
    ...
    <div class="card-body">
      ...
      <h3> Total view: ${news.total_view ? news.total_view : "no views"}</h3>
...
const handelModal = async (newsId) => {
  ...
  <form method="dialog" class="modal-box">
    ...
    <div class="modal-action">
      ...
      <button class="btn by-secondary">Close</button>
    </div>
  </form>
</dialog>
    `;
